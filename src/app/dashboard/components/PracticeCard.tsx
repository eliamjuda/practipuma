...
export const PracticeCard = ({ item }: PracticeCardProps) => {
  ...
  return (
    <div className="bg-(--principal-secondary-color) rounded-lg p-1 border border-(--shadow) flex items-center justify-between cursor-pointer">
          ...
          <div className="flex space-x-2">
              <p
                className={`px-2 py-1 text-xs rounded-full font-medium ${
                  item.priority === "Prioridad alta" || item.priority === "Urgente" 
                    ? "bg-(--red-main) border-(--red-secondary) border"
